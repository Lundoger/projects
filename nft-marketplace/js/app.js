(() => {
    ...
    function initSliders() {
        if (slider) {
            if (window.innerWidth <= 991.98 && "false" == slider.dataset.mobile) {
    ...
    if (mainPage) {
        function getTimeRemaining(endtime) {
            ...
            let hours = Math.floor(t / (1e3 * 60 * 60));
            return {
                total: t,
                hours,
                minutes,
        ...
        const deadline = "January 30 2023 00:00:00 GMT+0300";
    ...
    if (btnFollow) btnFollow.addEventListener("click", (e => {
        if (e.target.closest(".info-client__button--follow")) btnFollow.classList.toggle("signed");
    }));
    window["FLS"] = true;
    isWebp();
    addLoadedClass();
