(() => {
    ...
    (() => {
        ...
        da.init();
        const scrollBtn = document.querySelector(".main-screen__button");
        const mainSection = document.querySelector(".main-screen");
        const header = document.querySelector(".header");
        const mainSectionHeight = mainSection.clientHeight;
        const headerHeight = header.clientHeight;
        scrollBtn.addEventListener("click", setScrollTo);
        function setScrollTo() {
            window.scrollTo({
                top: mainSectionHeight - headerHeight,
                left: 0,
                behavior: "smooth"
            });
        }
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            let onPhoneInput = function(e) {
                ...
                if ("0" == inputNumbersValue[0] || "3" == inputNumbersValue[0] && "8" == inputNumbersValue[1]) {
                    if ("0" == inputNumbersValue[0]) inputNumbersValue = "38" + inputNumbersValue;
                    let firstSymbols = "0" == inputNumbersValue[0] ? "+" : "+38";
                    ...
                    if (inputNumbersValue.length >= 11) formattedInputValue += "-" + inputNumbersValue.substring(10, 13);
                } else formattedInputValue = "+" + inputNumbersValue.substring(0, 16);
                input.value = formattedInputValue;
            };
            let onPhoneKeyDown = function(e) {
                let inputValue = e.target.value.replace(/\D/g, "");
                if (8 == e.keyCode && 2 == inputValue.length) e.target.value = "";
            };
